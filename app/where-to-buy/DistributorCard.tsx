      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex items-center gap-3">
            <span className="material-symbols-outlined text-app-text-sec text-[20px]">call</span>
            <p className="text-sm text-app-text-sec break-all">{phone}</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="material-symbols-outlined text-app-text-sec text-[20px]">mail</span>
